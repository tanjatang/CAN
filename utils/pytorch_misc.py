...
# def save_checkpoint(model, optimizer, optimizer_mem, serialization_dir, epoch, val_metric_per_epoch, is_best=None,
#                         learning_rate_scheduler=None) -> None:
    """
    ...
    if serialization_dir is not None:
        ...
        #                   'optimizer_mem': optimizer_mem.state_dict()
        #                   }
        training_state = {'epoch': epoch,
                          'val_metric_per_epoch': val_metric_per_epoch,
                          'optimizer': optimizer.state_dict(),
...
# def restore_checkpoint(model, optimizer, optimizer_mem, serialization_dir, learning_rate_scheduler=None):
    """
    ...
    # optimizer_mem.load_state_dict(training_state["optimizer_mem"])
    ...
    # move_optimizer_to_cuda(optimizer_mem)

...
parser.add_argument(
    '-answer_ckpt',
    dest='answer_ckpt',
    default='/phys/ssd/tangxueq/tmp/64qacatnomask/best.th',
...
parser.add_argument(
    '-rationale_ckpt',
    dest='rationale_ckpt',
    default='/phys/ssd/tangxueq/tmp/r64qa/best.th',
...
loader_params = {'batch_size': 16 // NUM_GPUS, 'num_gpus': NUM_GPUS, 'num_workers': num_workers}
